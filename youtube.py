...
def is_from_youtube_music(yt_dlp_info: Any):
    desc = yt_dlp_info.get('description')
    return desc is not None and desc.startswith("Provided to YouTube by") and desc.endswith("Auto-generated by YouTube.")
